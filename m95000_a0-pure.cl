...
KERNEL_FQ void m95000_mxx (KERN_ATTR_RULES ())
{
  ...
  sha1_update_global_swap (&ctx2, salt_bufs[SALT_POS_HOST].salt_buf, salt_bufs[SALT_POS_HOST].salt_len);
  ...
  for (u32 il_pos = 0; il_pos < IL_CNT; il_pos++)
  {
    ...
    const u32 a1 = ctx.h[0];
    const u32 b1 = ctx.h[1];
    const u32 c1 = ctx.h[2];
    const u32 d1 = ctx.h[3];
    const u32 e1 = ctx.h[4];

    sha1_ctx_t ctx4 = ctx0;
    ...
    w01[0] = uint_to_hex_lower8_le ((a1 >> 16) & 255) <<  0
          | uint_to_hex_lower8_le ((a1 >> 24) & 255) << 16;
    w01[1] = uint_to_hex_lower8_le ((a1 >>  0) & 255) <<  0
          | uint_to_hex_lower8_le ((a1 >>  8) & 255) << 16;
    w01[2] = uint_to_hex_lower8_le ((b1 >> 16) & 255) <<  0
          | uint_to_hex_lower8_le ((b1 >> 24) & 255) << 16;
    w01[3] = uint_to_hex_lower8_le ((b1 >>  0) & 255) <<  0
          | uint_to_hex_lower8_le ((b1 >>  8) & 255) << 16;
    w11[0] = uint_to_hex_lower8_le ((c1 >> 16) & 255) <<  0
          | uint_to_hex_lower8_le ((c1 >> 24) & 255) << 16;
    w11[1] = uint_to_hex_lower8_le ((c1 >>  0) & 255) <<  0
          | uint_to_hex_lower8_le ((c1 >>  8) & 255) << 16;
    w11[2] = uint_to_hex_lower8_le ((d1 >> 16) & 255) <<  0
          | uint_to_hex_lower8_le ((d1 >> 24) & 255) << 16;
    w11[3] = uint_to_hex_lower8_le ((d1 >>  0) & 255) <<  0
          | uint_to_hex_lower8_le ((d1 >>  8) & 255) << 16;
    w21[0] = uint_to_hex_lower8_le ((e1 >> 16) & 255) <<  0
          | uint_to_hex_lower8_le ((e1 >> 24) & 255) << 16;
    w21[1] = uint_to_hex_lower8_le ((e1 >>  0) & 255) <<  0
          | uint_to_hex_lower8_le ((e1 >>  8) & 255) << 16;
    w21[2] = 0;
    w21[3] = 0;
    w31[0] = 0;
    w31[1] = 0;
    ...
    sha1_update_64 (&ctx4, w01, w11, w21, w31, 40);

    sha1_final (&ctx4);

    const u32 r0 = ctx4.h[DGST_R0];
    const u32 r1 = ctx4.h[DGST_R1];
    const u32 r2 = ctx4.h[DGST_R2];
    const u32 r3 = ctx4.h[DGST_R3];
